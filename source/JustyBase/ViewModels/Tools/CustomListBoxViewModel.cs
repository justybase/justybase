...
public partial class CustomListBoxViewModel : ObservableObject
{
    ...
    /// <summary>
    /// Called after filter is applied to refresh summaries
    /// </summary>
    public Action? OnFilterAppliedAction { get; set; }
    ...
    private void OkBtAction()
    {
        ...
        CloseAction?.Invoke();
        OnFilterAppliedAction?.Invoke(); // Refresh summaries after filter applied
    }
